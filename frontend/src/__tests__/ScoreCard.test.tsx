...
describe('ScoreCard', () => {
  describe('Loading state', () => {
    it('should display loading spinner when loading=true', () => {
      render(<ScoreCard runs={[]} loading={true} />);
    ...
    it('should not display run data when loading', () => {
      ...
      render(<ScoreCard runs={[mockRun]} loading={true} />);
  ...
  describe('Empty state', () => {
    it('should display empty state when runs is empty and not loading', () => {
      render(<ScoreCard runs={[]} loading={false} />);
  ...
  describe('Score display', () => {
    it('should display score as percentage', () => {
      ...
      render(<ScoreCard runs={[mockRun]} loading={false} />);
  ...
  describe('Multi-model display', () => {
    it('should show multiple score cards when multiple runs are provided', () => {
      const run1 = createMockRun({ model_id: 'model-1', model_display_name: 'Model 1', score: 0.85 });
      const run2 = createMockRun({ model_id: 'model-2', model_display_name: 'Model 2', score: 0.90 });
      render(<ScoreCard runs={[run1, run2]} loading={false} />);
    ...
    it('should display "Latest pass@1 Scores" title for multiple models', () => {
      const run1 = createMockRun({ model_id: 'model-1' });
      const run2 = createMockRun({ model_id: 'model-2' });
      render(<ScoreCard runs={[run1, run2]} loading={false} />);

      expect(screen.getByText('Latest pass@1 Scores')).toBeInTheDocument();
    });
  });
});
